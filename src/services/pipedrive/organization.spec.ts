// @ts-ignore
import {ApiClient, OrganizationFieldsApi, OrganizationsApi} from 'pipedrive';
...
import {ORG_LABEL_ID as ORG_LABEL_FIELD_ID, ORG_LABEL_OPTION, PipedriveOrganizationService} from './organization';
...
describe('Test Organization Service', () => {
    ...
    it('should add a new simple organization', async () => {
        ...
        expect(response.data?.name).toBe(contactForm.organization);
    });
